    ...
    for player in players:
        ...
        if player_info:
            ...
            for fixture_name, fixture_data in player["fixtures"].items():
                ...
                db.insert_fixture(player_name, fixture_name, fixture_points, player_team)
    ...
    for player in players:
        ...
        for fixture in player_fixtures:
            ...
            for event_key, event_data in events_dict.items():
                db.insert_event(fixture['fixture_id'], event_key, event_data["Quantity"], event_data["Points"])
...
def insert_DB():
    ...
    teams = {'מכבי פתח תקווה': {'overall': 3.0, 'attack': 3.0, 'defend': 3.0}, 'הפועל חיפה': {'overall': 3.0, 'attack': 4.0, 'defend': 3.0}, 'מכבי נתניה': {'overall': 3.0, 'attack': 4.0, 'defend': 3.0}, 'הפועל ירושלים': {'overall': 4.0, 'attack': 4.0, 'defend': 3.0}, 'בני סכנין': {'overall': 2.0, 'attack': 3.0, 'defend': 2.0}, 'מכבי חיפה': {'overall': 5.0, 'attack': 5.0, 'defend': 5.0}, 'מכבי בני ריינה': {'overall': 1.0, 'attack': 2.0, 'defend': 2.0}, 'מכבי תל אביב': {'overall': 5.0, 'attack': 5.0, 'defend': 5.0}, 'בית"ר ירושלים': {'overall': 4.0, 'attack': 4.0, 'defend': 3.0}, 'מ.ס. אשדוד': {'overall': 2.0, 'attack': 3.0, 'defend': 1.0}, 'הפועל חדרה': {'overall': 1.0, 'attack': 1.0, 'defend': 2.0}, 'הפועל תל אביב': {'overall': 3.0, 'attack': 3.0, 'defend': 3.0}, 'הפועל פתח תקווה': {'overall': 1.0, 'attack': 1.0, 'defend': 3.0}, 'הפועל באר שבע': {'overall': 4.0, 'attack': 4.0, 'defend': 4.0}}
